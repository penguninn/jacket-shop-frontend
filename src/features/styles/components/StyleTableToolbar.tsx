...
import { useImportStyles } from "../hooks";
...
export function StyleTableToolbar<TData>({ table }: Props<TData>) {
    const isFiltered = table.getState().columnFilters.length > 0;
    const fileInputRef = useRef<HTMLInputElement>(null);
    const { mutate: importStyles, isPending: isImporting } = useImportStyles();
