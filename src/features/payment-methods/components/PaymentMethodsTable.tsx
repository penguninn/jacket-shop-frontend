...
import { PaymentMethodTableToolbar } from "./PaymentMethodTableToolbar";
import { columns } from "./PaymentMethodTableColumns";
import { usePaymentMethods, useBulkUpdatePaymentMethodStatus } from "../hooks";
...
export function PaymentMethodsTable() {
    ...
    const bulkUpdateStatus = useBulkUpdatePaymentMethodStatus();
    ...
    return (
        <div className="space-y-4">
            <PaymentMethodTableToolbar table={table} />
